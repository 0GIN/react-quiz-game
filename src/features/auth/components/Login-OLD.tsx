...
export default function Login() {
  ...
  console.log('� Login.tsx RENDER - user:', user?.username || 'null', 'loading:', loading);
  console.log('📧 Email state:', email);
  console.log('🔒 Password state:', password ? '***' : 'PUSTY');
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // Walidacja
    if (!email || !password) {
      console.log('❌ Walidacja: puste pola');
    ...
    try {
      console.log('🔐 Wywołuję login() z AuthContext...');
      const result = await login(email, password);
      console.log('📊 Wynik login():', result);

      if (result.success) {
        console.log('✅ Login sukces - redirect');
        setLoading(false);
      ...
      console.error('💥 Exception w handleSubmit:', err);
