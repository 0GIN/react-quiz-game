...
-- KROK 6: Polityki RLS dla friendships
-- Enable RLS
...
SELECT '✅ Friendships RLS policies dodane' as status;
...
WHERE schemaname = 'public'
  AND tablename IN ('daily_missions', 'user_daily_missions', 'user_stats', 'game_questions', 'game_answers', 'friendships')
